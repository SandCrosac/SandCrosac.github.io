...
<head>
   ...
   <meta charset="utf-8"> 
   <title>猪猪的蜜语星球 - 蜜语翻译器,文字加密通话,一键转换,蜜语密码-FancyPig's blog</title>
   <meta name="keywords" content="蜜语,蜜语翻译,在线加密,蜜语密码,加密通话,在线转码解码FancyPig's blog">
    <meta name="description" content="可以将文字、字母、数字、代码、标点符号等内容转换成新的文字形式，通过简单的文字以不同的排列顺序来表达不同的内容FancyPig's blog！">
...
<div class="container" style="padding-top: 10px">
   ...
   <ul id="myTabs" class="nav nav-tabs" role="tablist">
      ...
      <li class="nav-item" style="width: 20%;" align="center">
        <a href="https://www.iculture.cc">博客</a>
      </li>
      <li class="nav-item" style="width: 20%;" align="center">
        <a href="https://www.iculture.cc/qun">通知</a>
      </li>
    </ul>
      ...
      <div class="tab-pane fade in active" id="jm">
       ...
       <div class="tab-pane fade in" id="about">
         <blockquote class="blockquote">
            <p>猪猪的蜜语可以将文字、字母、数字、代码、标点符号等内容转换成新的文字形式，通过简单的文字以不同的排列顺序来表达不同的内容！</p>
            <footer>Designde by FancyPig's blog</footer>
          </blockquote>
       </div>
</div>
</div>
