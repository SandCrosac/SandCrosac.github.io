                        ...
                        <div style="text-align: center;background: #fff;padding: 15px 10px;border-radius: 5px;box-shadow: 0 3px 17px -7px rgba(96, 125, 139, 0.31);">
                            <a href="{#HYBBS_URL('my',$v['user'])}">
                                <div style="position: relative;">
                                    ...
                                    <img class="swiper-lazy" src="{#WWW}View/nd_mobile/img/load_q_2.svg" data-src="{#WWW}{php echo $User->avatar($v['user'])['b']}" style="border-radius: 50%; width: 65px;{if is_vip($v['uid'])}border:3px solid #FF5722;{/if}">
