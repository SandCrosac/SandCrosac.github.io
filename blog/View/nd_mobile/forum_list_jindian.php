                    ...
                    <div>
                        ...
                        <p style="margin-left:-3px;">
                            ...
                            {php $user_lv = explode("|",$lv);}
                                ...
                                <span class="lv" style="color: {$user_lv.1};background: {$user_lv.2};border-radius: 1.5px;font-size: 12px;padding: 2px 4px;box-shadow: 0 1px 10px -2px {$user_lv.2};">Lv.{$key+1}</span>
                                {php break;}
                                {/if}
