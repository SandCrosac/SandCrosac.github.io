...
<div class="user_tongji">
    <div class="user_tongji_bg">
        ...
        <li>
                <a href="" data-ydui-actionsheet="{target:'#actionSheet',closeElement:'#cancel'}">{$user.fans} <span>粉丝</span></a>
        </li>
        <li>
                <a href="" >{$user.gold} <span>金币</span></a>
        </li>
    </div>
</div>
<div class="g-view">
    ...
    <div class="user_zil">
        <div class="m-cell" style="margin: 10px 10px;border-radius: 5px;box-shadow: 0 3px 17px -7px rgba(96, 125, 139, 0.31);">
            ...
            <div class="cell-item">
                <div class="cell-left"><a href="{#HYBBS_URL('my',$user['user'])}">个人主页</a></div>
                <a class="cell-right cell-arrow" href="{#HYBBS_URL('my',$user['user'])}"></a>
            </div>
        
            <div class="cell-item">
                <div class="cell-left"><a href="{#HYBBS_URL('my',$user['user'],'thread')}">我的帖子</a></div>
                <a class="cell-right cell-arrow" href="{#HYBBS_URL('my',$user['user'],'thread')}">{$user.threads}</a>
            </div>
            <div class="cell-item">
                <div class="cell-left"><a href="{#HYBBS_URL('my',$user['user'],'collection')}">我的收藏</a></div>
                <a class="cell-right cell-arrow" href="{#HYBBS_URL('my',$user['user'],'collection')}">{$collection}</a>
            </div>
            <div class="cell-item">
                <div class="cell-left"><a href="{#HYBBS_URL('my',$user['user'],'post')}">我的回帖</a></div>
                <a class="cell-right cell-arrow" href="{#HYBBS_URL('my',$user['user'],'post')}">{$user.posts}</a>
            </div>
        </div>
        <div class="m-cell" style="margin: 10px 10px;border-radius: 5px;box-shadow: 0 3px 17px -7px rgba(96, 125, 139, 0.31);">
            {hook user_my_op}
            <div class="cell-item">
                <div class="cell-left"><a href="{#HYBBS_URL('my',$user['user'],'op')}">账号设置</a></div>
                <a class="cell-right cell-arrow" href="{#HYBBS_URL('my',$user['user'],'op')}"></a>
            </div>
            <div class="cell-item">
