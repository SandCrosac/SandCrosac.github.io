...
<div class="g-view">
            ...
            <div class="right">
                <h1>
                    ...
                    ?>
                        ...
                        ?>
                    <span class="user_name" style="{if is_vip($data['uid'])||$is_renzheng}color:{$renzheng_inc.color}{/if}">
                        {$data.user}
                        {if $is_renzheng}
    ...
    <div class="m-cell" style="margin: 10px 10px;border-radius: 5px;box-shadow: 0 3px 17px -7px rgba(96, 125, 139, 0.31);">
        <div class="cell-item">
            <div class="cell-left"><a href="{#HYBBS_URL('my',$data['user'],'thread')}">他的帖子</a></div>
            <div class="cell-right cell-arrow"><a href="{#HYBBS_URL('my',$data['user'],'threads')}">{$data.threads}</a></div>
        </div>
        <div class="cell-item">
            <?php
                $collection = S('plugins_collection')->count(['uid'=>$data['uid']]);
            ?>
            <div class="cell-left"><a href="{#HYBBS_URL('my',$data['user'],'collection')}">他的收藏</a></div>
            <div class="cell-right cell-arrow"><a href="{#HYBBS_URL('my',$data['user'],'collection')}">{$collection}</a></div>
        </div>
        <div class="cell-item">
            <div class="cell-left"><a href="{#HYBBS_URL('my',$data['user'],'post')}">他的回帖</a></div>
            <div class="cell-right cell-arrow"><a href="{#HYBBS_URL('my',$data['user'],'posts')}">{$data.posts}</a></div>
        </div>
    </div>
    </div>
    <!-- 回复 -->
